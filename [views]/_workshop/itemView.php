...
<div class="container limited">
	<div class="nav">
		...
		if($MODEL['prev'])
		{?>
			<a href="/<?=LANG?>/workshop/<?=$MODEL['prev']->urlPiece()?>">&larr;  </a>
		<?php 
		}?>
		</div>
			
		<div class="center"><a href="/<?=LANG?>/workshop">Назад к списку</a></div>	
			
		<div class="right">
		<?php 
		if($MODEL['next'])
		{?>
			<a href="/<?=LANG?>/workshop/<?=$MODEL['next']->urlPiece()?>">&rarr;</a>
		<?php 
		}?>
		</div>
		<div class="clear"></div>	
