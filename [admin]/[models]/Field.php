...
class Field2
{
	...
	function drawInput($value, $lang/*для тайтлов картинок*/)
	{
		...
		switch($this->type)
		{
			...
			case "date":
					$str.='
					<input type="text" name="'.$this->code.'" id="'.$this->code.'" value="'.substr($value, 0, 10).'"  style="width:70px"> <img id="'.$this->code.'-calendar-btn" src="/js/calendar/calendar.jpg" style="border:0px;">
