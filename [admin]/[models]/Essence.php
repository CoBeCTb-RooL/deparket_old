...
class Essence2
{
	...
	function createTables()
	{
		...
		{
			Essence2::createTable($this->code, Entity2::TYPE_ELEMENTS, $lang);
			if(!($this->jointFields || $this->linear))
				Essence2::createTable($this->code, Entity2::TYPE_BLOCKS, $lang);
		}
	}
	...
	function dropTables()
	{
		...
		foreach($_CONFIG['LANGS'] as $lang=>$val)
		{
			Essence2::dropTable($this->code, Entity2::TYPE_ELEMENTS, $lang);
			if( !($this->jointFields || $this->linear) )
				Essence2::dropTable($this->code, Entity2::TYPE_BLOCKS, $lang);
		}
	}
