...
<body >
	...
	<div class="container">
		...
		<div class="table full-width full-height">
			...
			<? Slonne::view(SHARED_VIEWS_DIR.'/menu2.php', $tmp = array('menu'=>$GLOBALS['MENU2']));?>
			
			<!--<div class="row">
				<div class="cell"><? Slonne::view(SHARED_VIEWS_DIR.'/menu.php', $tmp = array('menu'=>$GLOBALS['MENU'], 'class'=>"menu"));?></div>	
			</div>-->
			
			<div class="row">
				<div class="cell full-height">
					<? //Slonne::view(SHARED_VIEWS_DIR.'/menu.php', $tmp = array('menu'=>$GLOBALS['MENU'], 'class'=>"leftMenu"));?>
