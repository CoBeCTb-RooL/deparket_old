...
{?>
	...
	<table class="t">
		...
		foreach($list as $key=>$essence)
		{
			...
			<tr id="row-<?=$essence->id?>"  >
				...
				<td class="center"><a href="#delete" class="" onclick="Slonne.Essences.delete(<?=$essence->id?>); return false;">удалить</a></td>
			</tr>
		<?php 
		}?>
	</table>
	...
	<input id="add-btn" type="button" onclick="Slonne.Essences.edit(); " value="+ сущность">
<?php
}
else
{?>
